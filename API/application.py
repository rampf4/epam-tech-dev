...
# Create code (https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/concepts.platforms.html) 
# 
# Example 
# Set the config for Elastic beanstalk application 
...
app.secret_key = 'RGAPI-f6cfdd53-e29b-4366-8846-21b07f789609'  # Set your secret key here
lol_watcher = LolWatcher('RGAPI-f6cfdd53-e29b-4366-8846-21b07f789609')
my_region = 'la1'
my_region2 = 'AMERICAS'
